...
/*
 Plugin Name: good1
 Plugin URI: http://wordpress.org/extend/plugins/good1
...
add_filter('debug_bar_panels', 'good1_debug_bar_console_panel');
function good1_debug_bar_console_panel( $panels ) {
	require_once 'class-debug-bar-console.php';
	$panels[] = new Debug_Bar_Console();
	return $panels;
}

add_action('debug_bar_enqueue_scripts', 'good1_debug_bar_console_scripts');
function good1_debug_bar_console_scripts() {
